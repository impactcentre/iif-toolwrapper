Tool Wrapper v0.6 [![Build Status](https://secure.travis-ci.org/impactcentre/iif-toolwrapper.png?branch=master)](http://travis-ci.org/impactcentre/iif-toolwrapper)
-----------------
...
2) If the build is successful (it should be), then run the toolwrapper jar you've just built
    ...
    java -jar ./target/toolwrapper-0.6.0-jar-with-dependencies.jar
